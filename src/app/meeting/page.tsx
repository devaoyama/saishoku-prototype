...
function MeetingContent() {
  ...
  const connectionType = (searchParams.get("type") === "phone" ? "phone" : "zoom") as "zoom" | "phone";
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8 animate-fade-in-up">
            ...
            <p className="text-[var(--muted-foreground)]">
              {connectionType === "zoom" ? "Zoomで面談を開始してください" : "電話で面談を開始してください"}
            </p>
          </div>
          ...
          {/* 接続方法（contact で選択した Zoom or 電話のみ表示・切り替え不可） */}
