          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-[var(--muted-foreground)]">
                CRM・選考管理・分析など、運営に必要な機能にアクセスできます
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {menuItems.map((item) => (
                <Link key={item.href} href={item.href}>
                  <Card className="border-none shadow-soft card-hover h-full">
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-4">
                        ...
                        {item.badge && (
                          <Badge className="bg-[var(--input)] text-[var(--foreground)] text-xs">
                            {item.badge}
                          </Badge>
                        )}
                      </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link href="/admin/candidates?status=new">
                  <Card className="border-none shadow-soft card-hover border-l-4 border-l-blue-500">
                    <CardContent className="p-4">
                ...
                <Link href="/admin/selections?status=offer">
                  <Card className="border-none shadow-soft card-hover border-l-4 border-l-green-500">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="font-medium text-[var(--foreground)]">
                        ...
                        <Badge className="bg-green-500 text-white">
                          {selections.filter((s) => s.status === "offer").length}
                          件
                        </Badge>
                      </div>
                    </CardContent>
